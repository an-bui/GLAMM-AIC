...
peng_lm2 <- lm(body_mass_g ~ flipper_length_mm + bill_length_mm, data = penguins)
AIC(peng_lm2)

peng_lm4 <- lm(body_mass_g ~ flipper_length_mm + bill_depth_mm, data = penguins)
AIC(peng_lm4)

peng_lm5 <- lm(body_mass_g ~ flipper_length_mm + sex, data = penguins)
AIC(peng_lm5)

peng_lm6 <- lm(body_mass_g ~ flipper_length_mm + sex + bill_depth_mm, data = penguins)
AIC(peng_lm6)
```

With these models, the best is `peng_lm6`, which has the lowest AIC value of `r AIC(peng_lm6)`. 
