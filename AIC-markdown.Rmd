...
$$
where $AIC_{min}$ is the smallest AIC value being compared (in this case, `r round(AIC(peng_lm4), 2)`), and $AIC_i$ is the AIC value for the model you want to compare (in this case, the AIC value for `peng_lm3` is `r round(AIC(peng_lm3), 2)`). Therefore, the $\Delta_i$ is `r round(AIC(peng_lm4)-AIC(peng_lm3), 2)`.
