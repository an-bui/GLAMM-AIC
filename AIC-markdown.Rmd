...
Let's start by visualizing the data, with body mass in grams as a function of flipper length.

```{r echo = FALSE, warning = FALSE}
penguins_plot <- ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, color = species)) +
  geom_point(size = 2.5, alpha = 0.8) +
  scale_color_manual(values = c("#E29244", "#4CA49E", "#6B6D9F")) +
  theme_bw() +
  labs(x = "Flipper length (mm)", y = "Body mass (g)", title = "Palmer Penguins", color = "Species") +
